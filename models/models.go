...
func InitDatabase() *gorm.DB {
	...
	if err != nil {
		...
		//logrus.Fatal("Fail to get section 'database': %v", err)
	}
...
//// CloseDB It is rare to Close a DB, as the DB handle is meant to be long-lived and shared between many goroutines.
//func CloseDB() {
//	mysqlDB, err := db.DB()
//	if err != nil {
//		//log.Println(err)
